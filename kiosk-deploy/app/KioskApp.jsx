...
function MapScreen() {
  return (
    <div style={{ padding: '32px 40px 60px' }}>
      <ScreenTitle title="Location" sub="1244 Sarah Lane, Auburn, Alabama 36830" />
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', color: 'white', background: 'rgba(0,0,0,0.4)', padding: 32, borderRadius: 4, backdropFilter: 'blur(8px)' }}>
            ...
            <div className="sans" style={{ fontSize: 13, marginTop: 16, opacity: 0.8, fontStyle: 'italic' }}>
              Interactive Google Map will load here on the live kiosk
            </div>
          </div>
        </div>
      </div>
